            ...
            <div class="swiper-wrapper row gutter-no cols-1">
                @foreach($sliders as $index => $slider)
                    <div class="swiper-slide banner banner-fixed intro-slide intro-slide{{ $index + 1 }}"
                         style="background-image: url({{ $slider->background_image ? Storage::url($slider->background_image) : '' }}); background-color: {{ $slider->background_color ?? '#f1f0f0' }};">
                        <div class="container">
                            <figure class="slide-image floating-item slide-animate"
                                    data-animation-options="{'name': 'fadeInDownShorter', 'duration': '1s'}">
                                @if($slider->image)
                                    <img src="{{ Storage::url($slider->image) }}" alt="Slide Image">
                                @else
                                    {{-- Fallbacks for seed data --}}
                                    @if($index === 0) <img src="{{ asset('assets/images/demos/demo2/slides/ski.png') }}" alt="Ski" width="729" height="570">
                                    @elseif($index === 1) <img src="{{ asset('assets/images/demos/demo2/slides/woman.png') }}" alt="Fashion" width="865" height="732">
                                    @else <img src="{{ asset('assets/images/demos/demo2/slides/man.png') }}" alt="Deals" width="527" height="481">
                                    @endif
                                @endif
                            </figure>
                            <div class="banner-content {{ $slider->alignment === 'right' ? 'text-right ml-auto y-50' : 'y-50' }}">
                                @if($slider->subtitle)
    ...
    <div class="container">
                ...
                <div class="row category-wrapper electronics-cosmetics appear-animate mb-7">
                    <div class="col-md-6 mb-4">
                        <div class="banner banner-fixed br-sm">
                            <figure>
                                <img src="assets/images/demos/demo2/categories/1-1.jpg" alt="Category Banner" width="640" height="200" style="background-color: #25282D;">
                            </figure>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="banner banner-fixed br-sm">
                            <figure>
                                <img src="assets/images/demos/demo2/categories/1-2.jpg" alt="Category Banner" width="640" height="200" style="background-color: #eeedec;">
                            </figure>
                            <div class="banner-content y-50">
                ...
                <div class="row category-wrapper sports-fashion mb-8 appear-animate">
                    <div class="col-md-6 mb-4">
                        <div class="banner banner-fixed br-sm">
                            <figure>
                                <img src="assets/images/demos/demo2/categories/2-1.jpg" alt="Category Banner" width="640" height="200" style="background-color: #EAEAEA;">
                            </figure>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="banner banner-fixed br-sm">
                            <figure>
                                <img src="assets/images/demos/demo2/categories/2-2.jpg" alt="Category Banner" width="640" height="200" style="background-color: #181411;">
                            </figure>
                            <div class="banner-content y-50">
                ...
                <div class="banner br-sm banner-electronics appear-animate" style="background-image: url(assets/images/demos/demo2/banners/3.jpg);
                    ...
                    <a href="shop-banner-sidebar.html" class="btn btn-white btn-rounded btn-icon-right mt-1">Shop Now<i class="w-icon-long-arrow-right"></i></a>
                </div>
                <!-- End of Banner -->
